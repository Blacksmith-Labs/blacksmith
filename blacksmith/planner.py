...
# From https://github.com/jxnl/openai_function_call/blob/main/examples/query_planner_execution/query_planner_execution.py
...
class QueryPlan(OpenAISchema):
    ...
    query_graph: List[Query] = Field(..., description="The original question we are asking")
